...
for num=1:3
    ...
    storage_xcorr_theoretical(num,:)=(besselj(0,2*pi*frequency_doppler_shift.*temp_xcorr_xaxis)+Kc(num).^2)./max(besselj(0,2*pi*frequency_doppler_shift.*temp_xcorr_xaxis)+Kc(num).^2);
end
%%
